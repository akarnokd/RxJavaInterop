...
public class BackpressureHelperTest {
    ...
    @Test
    public void alreadyNegativeMaxLong() {
        assertEquals(Long.MIN_VALUE, BackpressureHelper.addCancel(new AtomicLong(Long.MIN_VALUE), 1));
    }

    @Test
    public void alreadyMaxLong() {
        assertEquals(Long.MAX_VALUE, BackpressureHelper.addCancel(new AtomicLong(Long.MAX_VALUE), 1));
    }

    @Test
    public void producedNegativeMaxLong() {
        assertEquals(Long.MIN_VALUE, BackpressureHelper.producedCancel(new AtomicLong(Long.MIN_VALUE), 1));
    }

    @Test
    public void producedMaxLong() {
        assertEquals(Long.MAX_VALUE, BackpressureHelper.producedCancel(new AtomicLong(Long.MAX_VALUE), 1));
    }
}